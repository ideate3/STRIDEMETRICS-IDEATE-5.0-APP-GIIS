...
export const CalculatorsHub: React.FC<CalculatorsHubProps> = ({
  ...
  return (
    <div className="mx-auto max-w-7xl px-3 py-4 sm:px-6 sm:py-6 space-y-6">
      ...
      {/* Header Banner */}
      <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-emerald-500/10 via-teal-500/5 to-transparent border border-emerald-500/20 p-5 sm:p-7 backdrop-blur-md">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 relative z-10">
          <div>
            <div className="inline-flex items-center gap-2 rounded-full bg-emerald-500/15 border border-emerald-500/30 px-3 py-1 text-xs font-bold text-emerald-400 mb-2 font-mono">
              <Calculator className="h-3.5 w-3.5" />
              <span>Biometric Fitness Calculators & Tracking Engine</span>
            </div>
            <h1 className="text-2xl sm:text-3xl font-display font-black tracking-tight text-white">
              BMR, Body Fat & BMI Analytics
            </h1>
            <p className="text-xs sm:text-sm text-zinc-400 mt-1 max-w-2xl">
              Precision health metrics backed by Mifflin-St Jeor & US Navy formulas. Track your body composition, energy expenditure, and lean mass evolution over time.
            </p>
          </div>
          ...
          <div className="flex items-center gap-2.5">
            <button
              ...
              className="flex items-center gap-2 rounded-2xl bg-emerald-500 text-slate-950 px-4 py-2.5 text-xs sm:text-sm font-extrabold shadow-lg shadow-emerald-500/20 active:scale-95 transition-all hover:bg-emerald-400"
            >
        ...
        {[
          ...
          return (
            <button
              ...
              className={`flex items-center gap-2 rounded-2xl px-4 py-2.5 text-xs sm:text-sm font-bold tracking-wide transition-all whitespace-nowrap ${
                isActive
          ...
          <div className="rounded-3xl border border-white/10 bg-[#12121a]/90 p-5 space-y-4">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
              ...
              <button
                ...
                className="flex items-center gap-1.5 rounded-xl bg-white/10 hover:bg-white/15 px-3 py-1.5 text-xs font-bold text-white border border-white/10 self-start"
              >
      ...
      {showLogModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md">
          <div className="w-full max-w-md rounded-3xl border border-white/10 bg-[#12121a] p-6 space-y-5 shadow-2xl">
            <div className="flex items-center justify-between border-b border-white/10 pb-3">
