...
> **No.** When you or download this application from or GitHub, **private API keys and secrets (such as `GEMINI_API_KEY`) are deliberately omitted for security reasons thereby, you will be prompted to add your own api key as soon as you start chatting with your ai assistant**. 
...
## security:
this app is secured with various protocols including:
> **TLS, CSP, CORS, CSRF, XSS, SQL injection, IDOR protection, forced https and rate limiting**


## start from github guide:
>bash > la > cd "STRIDEMETRICS APP" > ls > if you see package.json > npm install


## 🚀 Quick Start Guide(via local)
